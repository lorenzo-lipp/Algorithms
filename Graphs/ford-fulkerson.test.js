let { fordFulkerson } = require("./ford-fulkerson");
...
describe("Testing Ford-Fulkerson Max Flow", () => {
    it("should return an object with a maxFlow and an edges properties", () => {
        let result = fordFulkerson(4, 5, graph1);
    ...
    it("maxFlow property should be a number", () => {
        expect(typeof fordFulkerson(4, 5, graph1).maxFlow).toBe("number");
    });

    it("edges property should be an array of adjacent edges", () => {
        let edges = fordFulkerson(4, 5, graph1).edges;
    ...
    it("should return a maxFlow of 20 for graph1", () => {
        expect(fordFulkerson(4, 5, graph1).maxFlow).toBe(20);
    });
    ...
    it("should return a maxFlow of 23 for graph2", () => {
        expect(fordFulkerson(9, 10, graph2).maxFlow).toBe(23);
    });

    it("should return have a correct flow for graph2", () => {
        let edges = fordFulkerson(9, 10, graph2).edges;
    ...
    it("should return a maxFlow of 20 for graph3", () => {
        expect(fordFulkerson(0, 10, graph3).maxFlow).toBe(20);
    });
});