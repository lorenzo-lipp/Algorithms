let { edmondsKarp } = require("./edmonds-karp");
...
describe("Testing Edmonds-Karp Max Flow", () => {
    it("should return an object with a maxFlow and an edges properties", () => {
        let result = edmondsKarp(4, 5, graph1);
    ...
    it("maxFlow property should be a number", () => {
        expect(typeof edmondsKarp(4, 5, graph1).maxFlow).toBe("number");
    });

    it("edges property should be an array of adjacent edges", () => {
        let edges = edmondsKarp(4, 5, graph1).edges;
    ...
    it("should return a maxFlow of 20 for graph1", () => {
        expect(edmondsKarp(4, 5, graph1).maxFlow).toBe(20);
    });
    ...
    it("should return a maxFlow of 23 for graph2", () => {
        expect(edmondsKarp(9, 10, graph2).maxFlow).toBe(23);
    });

    it("should return have a correct flow for graph2", () => {
        let edges = edmondsKarp(9, 10, graph2).edges;
    ...
    it("should return a maxFlow of 20 for graph3", () => {
        expect(edmondsKarp(0, 10, graph3).maxFlow).toBe(20);
    });
});