let { capacityScaling } = require("./capacity-scaling");
...
describe("Testing Capacity Scaling Max Flow", () => {
    it("should return an object with a maxFlow and an edges properties", () => {
        let result = capacityScaling(4, 5, graph1);
    ...
    it("maxFlow property should be a number", () => {
        expect(typeof capacityScaling(4, 5, graph1).maxFlow).toBe("number");
    });

    it("edges property should be an array of adjacent edges", () => {
        let edges = capacityScaling(4, 5, graph1).edges;
    ...
    it("should return a maxFlow of 20 for graph1", () => {
        expect(capacityScaling(4, 5, graph1).maxFlow).toBe(20);
    });
    ...
    it("should return a maxFlow of 23 for graph2", () => {
        expect(capacityScaling(9, 10, graph2).maxFlow).toBe(23);
    });

    it("should return have a correct flow for graph2", () => {
        let edges = capacityScaling(9, 10, graph2).edges;
    ...
    it("should return a maxFlow of 20 for graph3", () => {
        expect(capacityScaling(0, 10, graph3).maxFlow).toBe(20);
    });
});