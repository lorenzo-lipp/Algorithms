const { minimalNetwork } = require("./problem-107");
...
describe("Testing problem 107: minimal network", () => {
    it("should return a number", () => {
        expect(typeof minimalNetwork(matrix1)).toBe("number");
    });

    it("should return 150 when input matrix1", () => {
        expect(minimalNetwork(matrix1)).toBe(150);
    });

    it("should return 259679 when input matrix2", () => {
        expect(minimalNetwork(matrix2)).toBe(259679);
    });
});